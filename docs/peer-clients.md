...
Verdict-only; harness `exit 2` vs finding `panic!`. BIP324 and compact/reorg
...
|-----:|------|--------|----------|
| 1 | Height-1 + spend-pad + 2-block fork differential vs official v31.1 `bitcoind` (**landed**; BIP324 / compact P2P later) | satd `block_differential` | **Q-30** / [`TESTING.md`](../TESTING.md) |
