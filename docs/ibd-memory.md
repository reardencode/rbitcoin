...
| **`from_this_peer`** / **`announced_wtx`** | **50_000** txids / wtxids per session | Recency FIFO at cap (re-insert moves to back; oldest dropped). ~32 B extra deque RAM per peer at full. |
