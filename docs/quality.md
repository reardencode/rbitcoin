...
| **Q-41** | Keep rank 1. 62 → **65** `run`. 202 skips; `rpc-missing` 21 + `core-log` 23 are the growth matching claimed surface. Leftover flake: `rpc_createmultisig` `generate(149)` then `sync_blocks` 60s (deflake later). |
