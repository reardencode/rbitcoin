...
//! **0.8 plan** ([`docs/esplora-mempool-backend.md`](../../../docs/esplora-mempool-backend.md)):
//! mempool/electrs `/internal/*` bulk routes + unix listen so this process can
//! replace Core+electrs behind mempool.space `/api/`. Address-prefix search is
//! out. `GET …/txs/summary` is a mempool.space-shaped compact dialect (not
