...
| Multi‑GiB / mainnet head scale under `cargo test` | `StoreLayout::tiny` / `Query::open_or_create_tiny`; Mainnet only as a slot/shard/bit pin that does not create those files |
